    ...
    def _check_empty(query: str) -> None:
        if not query or not query.strip():
            raise InputGuardException(
                "No speech was detected from your microphone. Please try toggling between different input devices in the dropdown above (e.g. Earphones/Headset vs Default Microphone).",
                reason="empty_query",
            )
